...
class Css extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
	   ...
	   $custom_font = $helper->getStoreConfig('mgstheme/fonts/custom_fonts_element', $storeId);
		...
		if(($helper->getStoreConfig('color/product_background/background_color', $storeId) != '') && ($helper->getStoreConfig('color/product_background/background_color', $storeId) != 'transparent')){
			$productColorSetting = $helper->getProductBackgroundSetting($storeId);
