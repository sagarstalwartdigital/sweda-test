...
namespace MGS\Gallery\Block\Adminhtml\Post\Edit\Tab;
...
use MGS\Gallery\Model\System\Config\Status;
use MGS\Gallery\Model\System\Config\Yesno;
use MGS\Gallery\Model\System\Config\VideoType;
use MGS\Gallery\Model\System\Config\ImageType;
use MGS\Gallery\Model\Source\Category;
...
class Main extends Generic implements TabInterface
{
  ...
  //       );
        ...
        $fieldset->addField(
            'thumbnail',
            'image',
            ['name' => 'thumbnail', 'label' => __('Catalog Upload'), 'title' => __('Thumbnail'), 'required' => false]
        );

        $fieldset->addField(
            'button_link',
            'text',
            ['name' => 'post[button_link]', 'label' => __('Catalog Link'), 'title' => __('Catalog Link'), 'required' => false]
        );

        $fieldset->addField(
            'image_type',
            'select',
            ['name' => 'post[image_type]', 'label' => __('Small Image Type'), 'note' => __('Show on Post Detail'), 'title' => __('Image Type'), 'options' => $this->_imageType->toOptionArray()]
        );
        ...
        $fieldset->addField(
            'image',
            'image',
            ['name' => 'image', 'label' => __('Image'), 'title' => __('Small Image'), 'required' => false]
        );

        // $fieldset->addField(
        //     'button_title',
        //     'text',
        //     ['name' => 'post[button_title]', 'label' => __('Button Title'), 'title' => __('Button Title'), 'required' => false]
        // );
        ...
        //     'content',
        //     'editor',
        //     ['name' => 'post[content]', 'label' => __('Content'), 'title' => __('Content'), 'required' => false, 'config' => $wysiwygConfig]
        // );
