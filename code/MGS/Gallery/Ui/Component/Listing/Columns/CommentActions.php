...
namespace MGS\Gallery\Ui\Component\Listing\Columns;

use Magento\Framework\View\Element\UiComponent\ContextInterface;
use Magento\Framework\View\Element\UiComponentFactory;
use Magento\Ui\Component\Listing\Columns\Column;
use MGS\Gallery\Block\Adminhtml\Comment\Grid\Renderer\Action\UrlBuilder;
use Magento\Framework\UrlInterface;

class CommentActions extends Column
{
    const COMMENT_URL_PATH_APPROVE = 'gallery/comment/approve';
    const COMMENT_URL_PATH_UNAPPROVE = 'gallery/comment/unapprove';
    const COMMENT_URL_PATH_DELETE = 'gallery/comment/delete';
