...
use MGS\Gallery\Model\Resource\Post as PostResource;
use MGS\Gallery\Model\Resource\Post\Collection;
use MGS\Gallery\Helper\Data;
use Magento\Framework\UrlInterface;
use MGS\Gallery\Model\Category;
use MGS\Gallery\Model\Comment;
...
class Post extends AbstractModel
{
    ...
    {
        parent::_construct();
        $this->_init('MGS\Gallery\Model\Resource\Post');
    }
