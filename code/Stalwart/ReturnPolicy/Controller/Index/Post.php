...
namespace Stalwart\ReturnPolicy\Controller\Index;
...
class Post extends \Magento\Framework\App\Action\Action
{
    ...
    */
    ...
    public function execute()
    {
        ...
        $html = "";
            foreach ($multipal as $key => $value) {
             $html  = $html . '<tr><td style="font-family:Verdana,Geneva,sans-serif;font-size:12px; width:100%;"><p style="margin:0;color: #606c77;font-size: 13px;font-family: Verdana,Geneva,sans-serif;"><strong style=" ">Product Number #: </strong>'.$multipalVal[$key].'</p></td></tr>';

             $html .= '<tr><td style="font-family:Verdana,Geneva,sans-serif;font-size:12px; width:100%;"><p style="margin:0;color: #606c77;font-size: 13px;font-family: Verdana,Geneva,sans-serif;"><strong style=" ">Item Description: </strong>'.$value.'</p></td></tr>';
            }
        $postObject["combinedHtml"] = $html;
        }
