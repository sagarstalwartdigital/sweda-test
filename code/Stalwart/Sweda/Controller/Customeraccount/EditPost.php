...
namespace Stalwart\Sweda\Controller\Customeraccount;
...
class EditPost extends AbstractAccount implements CsrfAwareActionInterface, HttpPostActionInterface
{
    ...
    public function execute()
    {
        ...
        if ($validFormKey && $this->getRequest()->isPost()) {
            ...
            if (isset($postedData['email']) && !empty($postedData['email'])) {
                $customerCandidateDataObject->setEmail($postedData['email']);
            }
    ...
    private function processChangeEmailRequest(\Magento\Customer\Api\Data\CustomerInterface $currentCustomerDataObject)
    {
        if (!$this->getRequest()->getParam('change_email')) {
            ...
            try {
                $this->getAuthentication()->isLocked($currentCustomerDataObject->getId());
