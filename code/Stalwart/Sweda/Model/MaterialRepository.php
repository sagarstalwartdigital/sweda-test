...
use Stalwart\Sweda\Model\ResourceModel\Material\Collection;
use Stalwart\Sweda\Api\MaterialRepositoryInterface;
use Stalwart\Sweda\Model\ResourceModel\Material\CollectionFactory as MaterialCollectionFactory;
use Stalwart\Sweda\Api\Data\MaterialSearchResultInterfaceFactory as SearchResultFactory;
...
class MaterialRepository implements MaterialRepositoryInterface
{
    ...
    public function __construct(
        ResourceModel\Material $resourceMaterial,
        Data\MaterialInterfaceFactory $MaterialFactory,
    ...
    {
        try {
            $this->resourceMaterial->save($data);
        } catch (\Exception $e) {
    ...
    {
        $data = $this->MateriallineFactory->create();
        $this->resourceMaterial->load($data, $id);
        if (!$data->getId()) {
    ...
    {
        try {
            $this->resourceMaterial->delete($data);
        } catch (\Exception $e) {
            throw new CouldNotSaveException(__($e->getMessage()));
        }
        return $data;
