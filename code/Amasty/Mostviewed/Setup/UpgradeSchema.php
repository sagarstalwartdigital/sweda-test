...
class UpgradeSchema implements UpgradeSchemaInterface
{
    ...
    /**
     * @var UpgradeSchema\AddInfoColumn
     */
    private $addInfoColumn;

    /**
     * @var UpgradeSchema\AddCurrentCategory
     */
    private $addCurrentCategory;
    ...
    public function __construct(
        ...
        UpgradeSchema\AddInfoColumn $addInfoColumn,
        UpgradeSchema\AddCurrentCategory $addCurrentCategory
    ) {
        ...
        $this->addCurrentCategory = $addCurrentCategory;
    }
    ...
    public function upgrade(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (version_compare($context->getVersion(), '2.7.0', '<')) {
            $this->addInfoColumn->execute($setup);
        }

        if (version_compare($context->getVersion(), '2.8.0', '<')) {
            $this->addCurrentCategory->execute($setup);
        }
