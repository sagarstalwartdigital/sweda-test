    ...
    $.widget('mage.amShopbyFilterSlider', $.mage.amShopbyFilterAbstract, {
        ...
        _create: function () {
            $(function () {
                ...
                console.log("relaoded price slider", fromLabel, toLabel);
                var min_val = Number(fromLabel).toFixed(2);
                var max_val = Number(toLabel).toFixed(2);
                $('.custom-prices .min_price').html("$"+min_val+"ea");
                $('.custom-prices .max_price').html("$"+max_val+"ea");
        ...
        onChange: function (event, ui) {
            if (this.slider.skipOnChange !== true) {
                ...
                var min_val = Number(ui.values[0]).toFixed(2);
                var max_val = Number(ui.values[1]).toFixed(2);
                $('.custom-prices .min_price').html("$"+min_val+"ea");
                $('.custom-prices .max_price').html("$"+max_val+"ea");
                this.setValue(
                    ui.values[0],
        ...
        onSlide: function (event, ui) {
            ...
            var min_val = Number(from).toFixed(2);
            var max_val = Number(to).toFixed(2);
            $('.custom-prices .min_price').html("$"+min_val+"ea");
            $('.custom-prices .max_price').html("$"+max_val+"ea");
