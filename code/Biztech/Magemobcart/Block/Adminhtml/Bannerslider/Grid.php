...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function __construct(
        ...
        \Biztech\Magemobcart\Model\ResourceModel\Bannerslider\Collection $bannersliderCollection,
        array $data = []
    ) {
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            'index' => 'filename',
            'width' => 97,
            'renderer' => 'Biztech\Magemobcart\Block\Adminhtml\Bannerslider\Renderer\Image',
            'filter' => false,
            'sortable' => false,
                ]
        );
