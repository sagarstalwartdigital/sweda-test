...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function __construct(
        ...
        \Biztech\Magemobcart\Model\ResourceModel\Offerslider\Collection $bannersliderCollection,
        array $data = []
    ) {
    ...
    protected function _construct()
    {
        ...
        $this->setDefaultSort('offerslider_id');
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            'filename',
            [
            'header' => _('Offer Thumbnail'),
            'align' => 'left',
            'index' => 'filename',
            'width' => 97,
            'renderer' => 'Biztech\Magemobcart\Block\Adminhtml\Offerslider\Renderer\Image',
            'filter' => false,
            'sortable' => false,
                ]
        );
    ...
    {
        $this->setMassactionIdField('offerslider_id');
        $this->getMassactionBlock()->setFormFieldName('offerslider');
