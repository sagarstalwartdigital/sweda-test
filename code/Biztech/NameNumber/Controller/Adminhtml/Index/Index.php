...
namespace Biztech\NameNumber\Controller\Adminhtml\Index;
...
class Index extends \Magento\Backend\App\Action {
 ...
 public function execute() {
    try {
        ...
        $itemId = $productParams['item'];
        $itemCollection = $this->orderItemRepository->get($itemId);
        $itemCollectionData = $itemCollection->getData();
        $layout = $this->layoutFactory->create()->createBlock('Biztech\NameNumber\Block\Namenumber');
        ...
        $productParams['super_attributes'] = $itemCollectionData['product_options']['info_buyRequest']['super_attribute'];
        $result = $layout->setData(array("product_params" => $productParams,"page_title" => $pageTitle,"page_logo" => $pageLogo))->setTemplate('Biztech_NameNumber::namenumber/namenumber.phtml')->toHtml();
