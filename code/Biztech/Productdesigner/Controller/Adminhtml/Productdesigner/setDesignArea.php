...
class setDesignArea extends \Magento\Backend\App\Action {
    ...
    public function execute() {
        $resultPage = $this->_layoutInterface->createBlock('Biztech\Productdesigner\Block\Productdesigner');
        try {
            ...
            $result["design_area"] = $resultPage->setData($arr)->setTemplate('helper/designarea.phtml')->toHtml();
