...
abstract class Cliparts extends \Magento\Framework\App\Action\Action {
    ...
    public function fetchClipartImages($clipart_id, $limit = 12, $searchText = "", $page = 1) {
        try {
            ...
            if (($limit * $page) >= $getTotalRecord  || $totalClipartImages <= 0) {
                $loadMoreFlag = 0;
            } else {
                $loadMoreFlag = 1;
            }
