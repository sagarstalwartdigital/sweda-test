...
class SubTabsColumn extends \Magento\Ui\Component\Listing\Columns\Column
{
    /**
     * constructor
     * 
    ...
    public function prepareDataSource(array $dataSource) {
        ...
        if (isset($dataSource['data']['items'])) {
            ...
            $allSubTabs = array();
            $keyValueArr = $this->setKeyValueArray(array_merge($allSubTabs, $allMainTabs));
            $result = array();
            foreach ($dataSource['data']['items'] as $key => & $item) {
                $subtabarray = explode(",",$item['subtabs']);
                foreach ($keyValueArr as $subTabKey => $subTabValue) {
                    if(in_array($subTabKey, $subtabarray)){
                        $result[] = $subTabValue;
                    }
                }
                $item['subtabs'] = implode(",", $result);
                $result = [];
            }
        }
        return $dataSource;
