    ...
    public function _getProductCollection()
    {
        if ($this->_productCollection === null) {
            ...
            $collection->getSelect()
                ->join(
                    ['product_post' => $collection->getTable('mageplaza_vlibrary_post_product')],
                    "e.entity_id = product_post.entity_id"
                )
                ->where('product_post.post_id = ' . $postId)
                ->order('product_post.position ASC')
                ->limit((int) $this->helper->getVlibraryConfig('product_post/post_detail/product_limit') ?: self::LIMIT);
