...
use Mageplaza\Vlibrary\Helper\Data as DataHelper;
...
class Widget extends Frontend
{
    ...
    {
        return $this->helperData->getVlibraryConfig('monthly_archive/enable_monthly');
    }
    ...
    {
        $limit = $this->helperData->getVlibraryConfig('monthly_archive/number_records') ?: 5;
    ...
    {
        return $this->helperData->getVlibraryUrl($month, Data::TYPE_MONTHLY);
    }
