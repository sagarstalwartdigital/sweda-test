...
class Frontend extends Template
{
    ...
    /**
     * @var \Mageplaza\Vlibrary\Model\LikeFactory
     */
    public $likeFactory;
    ...
    {
       return strcmp($val1['post_id'], $val2['post_id']);
    }
    ...
    {
        $html = __('%1', $this->getDateFormat($post->getPublishDate()));
    ...
    public function getPostCategoryHtml($post)
    {
        ...
        foreach ($categories as $_cat) {
            $categoryHtml[] = '<a class="mp-info" href="' . $this->helperData->getVlibraryUrl(
                $_cat,
                Data::TYPE_CATEGORY
            ) . '">' . $_cat->getName() . '</a>';
        }
    ...
    {
        return $this->getViewFileUrl('Mageplaza_Vlibrary::media/images/mageplaza-logo-default.png');
    }
    ...
    {
        return $this->getViewFileUrl('Mageplaza_Vlibrary::media/images/no-artist-image.jpg');
    }
}
