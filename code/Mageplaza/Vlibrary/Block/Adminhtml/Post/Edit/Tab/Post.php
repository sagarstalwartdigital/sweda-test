...
namespace Mageplaza\Vlibrary\Block\Adminhtml\Post\Edit\Tab;
...
use Mageplaza\Vlibrary\Block\Adminhtml\Post\Edit\Tab\Renderer\Category;
use Mageplaza\Vlibrary\Block\Adminhtml\Post\Edit\Tab\Renderer\Tag;
use Mageplaza\Vlibrary\Block\Adminhtml\Post\Edit\Tab\Renderer\Topic;
use Mageplaza\Vlibrary\Helper\Image;

/**
 * Class Post
 * @package Mageplaza\Vlibrary\Block\Adminhtml\Post\Edit\Tab
 */
class Post extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $post = $this->_coreRegistry->registry('mageplaza_vlibrary_post');
        ...
        $fieldset->addField('image', \Mageplaza\Vlibrary\Block\Adminhtml\Renderer\Image::class, [
            'name'  => 'image',
        ...
        $fieldset->addField('shop_now_title', 'text', [
            'name'  => 'shop_now_title',
            'label' => __('Shop Now Title'),
            'title' => __('Shop Now Title')
        ]);
        
        $fieldset->addField('shop_now_link', 'text', [
            'name'  => 'shop_now_link',
            'label' => __('Shop Link'),
            'title' => __('Shop Link')
        ]);
        ...
        if (!$post->getId()) {
            $post->addData([
                'allow_comment'    => 1,
                'meta_title'       => $this->_scopeConfig->getValue('vlibrary/seo/meta_title'),
                'meta_description' => $this->_scopeConfig->getValue('vlibrary/seo/meta_description'),
                'meta_keywords'    => $this->_scopeConfig->getValue('vlibrary/seo/meta_keywords'),
                'meta_robots'      => $this->_scopeConfig->getValue('vlibrary/seo/meta_robots'),
            ]);
        }
