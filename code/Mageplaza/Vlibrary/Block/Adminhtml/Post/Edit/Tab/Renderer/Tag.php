...
use Mageplaza\Vlibrary\Model\ResourceModel\Tag\CollectionFactory as VlibraryTagCollectionFactory;
...
{
    /**
     * @var \Mageplaza\Vlibrary\Model\ResourceModel\Tag\CollectionFactory
     */
     ...
     * @param VlibraryTagCollectionFactory $collectionFactory
    ...
    public function __construct(
        ...
        Escaper $escaper,
        VlibraryTagCollectionFactory $collectionFactory,
    ...
    public function getElementHtml()
    {
        ...
        $html .= '<div id="vlibrary-tag-select" class="admin__field" data-bind="scope:\'vlibraryTag\'" data-index="index">';
    ...
    {
        $isNotAllowed = !$this->authorization->isAllowed('Mageplaza_Vlibrary::tag');
    ...
    {
        /* @var $collection \Mageplaza\Vlibrary\Model\ResourceModel\Tag\Collection */
    ...
    /**
     * Attach Vlibrary Tag suggest widget initialization
     *
     * @return string
     */
        ...
        $html = '<script type="text/x-magento-init">
            {
                ...
                ['handle' => 'mageplaza_vlibrary_tag_create', 'buttons' => 1]) . '",
                                        "autoRender": false,
                                        "ns": "vlibrary_new_tag_form",
                                        "externalProvider": "vlibrary_new_tag_form.new_tag_form_data_source",
