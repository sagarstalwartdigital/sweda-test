...
use Mageplaza\Vlibrary\Model\ResourceModel\Topic\CollectionFactory as VlibraryTopicCollectionFactory;
...
{
    /**
     * @var \Mageplaza\Vlibrary\Model\ResourceModel\Topic\CollectionFactory
     */
     ...
     * @param VlibraryTopicCollectionFactory $collectionFactory
    ...
    public function __construct(
        ...
        Escaper $escaper,
        VlibraryTopicCollectionFactory $collectionFactory,
    ...
    public function getElementHtml()
    {
        ...
        $html .= '<div id="vlibrary-topic-select" class="admin__field" data-bind="scope:\'vlibraryTopic\'" data-index="index">';
    ...
    {
        $isNotAllowed = !$this->authorization->isAllowed('Mageplaza_Vlibrary::topic');
    ...
    {
        /* @var $collection \Mageplaza\Vlibrary\Model\ResourceModel\Topic\Collection */
    ...
    /**
     * Attach Vlibrary Topic suggest widget initialization
     *
     * @return string
     */
        ...
        $html = '<script type="text/x-magento-init">
            {
                                ...
                                "children": {
                                    "vlibrary_select_topic": {
                                        ...
                                        "config": {
                                            ...
                                            "config": {
                                                "dataScope": "vlibrary_select_topic",
                                                "sortOrder": 10
                                            }
                                        }
                                    }
                ...
                ['handle' => 'mageplaza_vlibrary_topic_create', 'buttons' => 1]) . '",
                                        "autoRender": false,
                                        "ns": "vlibrary_new_topic_form",
                                        "externalProvider": "vlibrary_new_topic_form.new_topic_form_data_source",
