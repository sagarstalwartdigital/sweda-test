...
namespace Mageplaza\Vlibrary\Block\Adminhtml\Topic;
...
/**
 * Class Edit
 * @package Mageplaza\Vlibrary\Block\Adminhtml\Topic
 */
class Edit extends Container
{
    ...
    public function getHeaderText()
    {
        ...
        $topic = $this->coreRegistry->registry('mageplaza_vlibrary_topic');
        if ($topic->getId()) {
