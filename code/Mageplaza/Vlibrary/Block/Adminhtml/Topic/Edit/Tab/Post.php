...
namespace Mageplaza\Vlibrary\Block\Adminhtml\Topic\Edit\Tab;
...
/**
 * Class Post
 * @package Mageplaza\Vlibrary\Block\Adminhtml\Topic\Edit\Tab
 */
class Post extends Extended implements TabInterface
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(
            ['related' => $collection->getTable('mageplaza_vlibrary_post_topic')],
    ...
    /**
     * @return \Mageplaza\Vlibrary\Model\Topic
     */
    public function getTopic()
    {
        return $this->coreRegistry->registry('mageplaza_vlibrary_topic');
    }
    ...
    {
        return $this->getUrl('mageplaza_vlibrary/topic/posts', ['_current' => true]);
    }
