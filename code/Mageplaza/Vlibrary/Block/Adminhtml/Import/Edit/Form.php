...
use Mageplaza\Vlibrary\Helper\Image as ImageHelper;
use Mageplaza\Vlibrary\Model\Config\Source\Import\Behaviour;
...
class Form extends Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldsets['base']->addField('import_type', 'select', [
            ...
            'required' => true,
            'onchange' => 'mpVlibraryImport.initImportFieldsSet();'
        ]);
        ...
        foreach ($fieldsetList as $item) {
            ...
            $fieldsets[$item["value"]]->addField($item["value"] . '_import_behaviour', 'select', [
                ...
                'onchange' => 'mpVlibraryImport.initExpandBehaviour();'
            ]);
