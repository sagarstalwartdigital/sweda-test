...
namespace Mageplaza\Vlibrary\Block\Adminhtml\Comment\Edit\Tab;
...
/**
 * Class Comment
 * @package Mageplaza\Vlibrary\Block\Adminhtml\Comment\Edit\Tab
 */
class Comment extends Generic implements TabInterface
{
    ...
    {
        $comment = $this->_coreRegistry->registry('mageplaza_vlibrary_comment');
        ...
        $postText = '<a href="' . $this->getUrl('mageplaza_vlibrary/post/edit', ['id' => $comment->getPostId()])
