...
namespace Mageplaza\Vlibrary\Block\Adminhtml\Comment;
...
/**
 * Class Edit
 * @package Mageplaza\Vlibrary\Block\Adminhtml\Comment
 */
class Edit extends Container
{
    ...
    {
        /** @var \Mageplaza\Vlibrary\Model\Comment $comment */
        $comment = $this->coreRegistry->registry('mageplaza_vlibrary_comment');
        if ($comment->getId()) {
