...
namespace Mageplaza\Vlibrary\Block\Adminhtml\Category;
...
use Mageplaza\Vlibrary\Model\ResourceModel\Category\Tree as VlibraryTreeResource;
...
class Tree extends \Magento\Catalog\Block\Adminhtml\Category\Tree
{
     ...
     * @param \Mageplaza\Vlibrary\Model\ResourceModel\Category\Tree $vlibraryCategoryTree
     * @param \Mageplaza\Vlibrary\Model\CategoryFactory $vlibraryCategoryFactory
     * @param array $data
     */
    public function __construct(
        ...
        VlibraryTreeResource $vlibraryCategoryTree,
        CategoryFactory $vlibraryCategoryFactory,
        array $data = []
    ) {
        parent::__construct(
            $context,
    ...
    {
        return $this->getUrl('mageplaza_vlibrary/category/jsonTree');
    }
    ...
    {
        return $this->getUrl('mageplaza_vlibrary/category/move');
    }
    ...
    protected function _getNodeJson($node, $level = 0)
    {
        ...
        if (!empty($storeIds) && !in_array(0, $storeIds) && !is_null($this->_vlibraryStore) && !in_array(
            $this->_vlibraryStore,
            $storeIds
        )) {
            return null;
