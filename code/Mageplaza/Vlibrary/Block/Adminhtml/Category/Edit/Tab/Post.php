...
namespace Mageplaza\Vlibrary\Block\Adminhtml\Category\Edit\Tab;
...
/**
 * Class Post
 * @package Mageplaza\Vlibrary\Block\Adminhtml\Category\Edit\Tab
 */
class Post extends Extended implements TabInterface
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(
            ['related' => $collection->getTable('mageplaza_vlibrary_post_category')],
    ...
    /**
     * @return \Mageplaza\Vlibrary\Model\Category
     */
    ...
    {
        return $this->getUrl('mageplaza_vlibrary/category/posts', ['_current' => true]);
    }
