...
namespace Mageplaza\Vlibrary\Block\Adminhtml\Category\Edit;
...
use Mageplaza\Vlibrary\Model\CategoryFactory as VlibraryCategoryFactory;
use Mageplaza\Vlibrary\Model\ResourceModel\Category\Tree as VlibraryResourceTree;

/**
 * Class Form
 * @package Mageplaza\Vlibrary\Block\Adminhtml\Category\Edit
 */
class Form extends AbstractCategory
{
     ...
     * @param VlibraryResourceTree $vlibraryCategoryTree
     * @param VlibraryCategoryFactory $vlibraryCategoryFactory
    ...
    public function __construct(
        ...
        VlibraryResourceTree $vlibraryCategoryTree,
        VlibraryCategoryFactory $vlibraryCategoryFactory,
        ...
        $this->_categoryTree = $vlibraryCategoryTree;
        $this->_categoryFactory = $vlibraryCategoryFactory;
    }
    ...
    protected function _prepareLayout()
    {
        ...
        $categoryId = (int) $category->getId(); // 0 when we create Vlibrary Category, otherwise some value for editing Vlibrary Category

        $this->setChild(
            'tabs',
            $this->getLayout()->createBlock('Mageplaza\Vlibrary\Block\Adminhtml\Category\Edit\Tabs', 'tabs')
        );
        ...
        $this->addButton('save', [
            ...
            'data_attribute' => [
                'mage-init' => [
                    'Mageplaza_Vlibrary/category/edit' => [
                        'url'  => $this->getSaveUrl(),
                        'ajax' => true
                    ]
                ]
        ...
        // Reset button
        $resetPath = $categoryId ? 'mageplaza_vlibrary/*/edit' : 'mageplaza_vlibrary/*/add';
    ...
    public function getSaveUrl(array $args = [])
    {
        ...
        return $this->getUrl('mageplaza_vlibrary/*/save', $params);
    }
    ...
    {
        return $this->getUrl('mageplaza_vlibrary/category/edit', ['_query' => false, 'id' => null, 'parent' => null]);
    }
    ...
    public function getDeleteUrl(array $args = [])
    {
        ...
        return $this->getUrl('mageplaza_vlibrary/*/delete', $params);
    }
    ...
    public function getRefreshPathUrl(array $args = [])
    {
        ...
        return $this->getUrl('mageplaza_vlibrary/*/refreshPath', $params);
    }

    /**
     * Get parent Vlibrary Category id
     *
     * @return int
     */
