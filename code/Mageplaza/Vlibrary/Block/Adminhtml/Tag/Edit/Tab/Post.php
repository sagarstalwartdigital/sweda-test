...
namespace Mageplaza\Vlibrary\Block\Adminhtml\Tag\Edit\Tab;
...
/**
 * Class Post
 * @package Mageplaza\Vlibrary\Block\Adminhtml\Tag\Edit\Tab
 */
class Post extends Extended implements TabInterface
{
     ...
     * @param \Mageplaza\Vlibrary\Model\ResourceModel\Post\CollectionFactory $postCollectionFactory
     * @param array $data
     */
    ...
    {
        /** @var \Mageplaza\Vlibrary\Model\ResourceModel\Post\Collection $collection */
        $collection = $this->postCollectionFactory->create();
        $collection->getSelect()->joinLeft(
            ['related' => $collection->getTable('mageplaza_vlibrary_post_tag')],
    ...
    /**
     * @param \Mageplaza\Vlibrary\Model\Post|\Magento\Framework\Object $item
     *
     * @return string
     */
    ...
    /**
     * @return \Mageplaza\Vlibrary\Model\Tag
     */
    public function getTag()
    {
        return $this->coreRegistry->registry('mageplaza_vlibrary_tag');
    }
    ...
    {
        return $this->getUrl('mageplaza_vlibrary/tag/posts', ['_current' => true]);
    }
