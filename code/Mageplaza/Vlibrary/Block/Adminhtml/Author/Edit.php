...
namespace Mageplaza\Vlibrary\Block\Adminhtml\Author;
...
/**
 * Class Edit
 * @package Mageplaza\Vlibrary\Block\Adminhtml\Author
 */
class Edit extends Container
{
    ...
    public function getHeaderText()
    {
        ...
        $author = $this->coreRegistry->registry('mageplaza_vlibrary_author');
        if ($author->getId()) {
