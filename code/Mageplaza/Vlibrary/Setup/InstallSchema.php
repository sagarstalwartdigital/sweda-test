...
/**
 * Class InstallSchema
 * @package Mageplaza\Vlibrary\Setup
 */
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (!$installer->tableExists('mageplaza_vlibrary_post')) {
            $table = $installer->getConnection()
                ->newTable($installer->getTable('mageplaza_vlibrary_post'))
        ...
        if (!$installer->tableExists('mageplaza_vlibrary_tag')) {
            $table = $installer->getConnection()
                ->newTable($installer->getTable('mageplaza_vlibrary_tag'))
        ...
        if (!$installer->tableExists('mageplaza_vlibrary_topic')) {
            $table = $installer->getConnection()
                ->newTable($installer->getTable('mageplaza_vlibrary_topic'))
        ...
        if (!$installer->tableExists('mageplaza_vlibrary_category')) {
            $table = $installer->getConnection()
                ->newTable($installer->getTable('mageplaza_vlibrary_category'))
        ...
        if (!$installer->tableExists('mageplaza_vlibrary_post_tag')) {
            $table = $installer->getConnection()
                ->newTable($installer->getTable('mageplaza_vlibrary_post_tag'))
                ->addColumn('tag_id', Table::TYPE_INTEGER, null, [
                    'unsigned' => true,
                    'primary'  => true,
                    'nullable' => false
                ...
                ->addIndex($installer->getIdxName('mageplaza_vlibrary_post_tag', ['post_id']), ['post_id'])
                ->addIndex($installer->getIdxName('mageplaza_vlibrary_post_tag', ['tag_id']), ['tag_id'])
                ->addForeignKey(
                    $installer->getFkName('mageplaza_vlibrary_post_tag', 'post_id', 'mageplaza_vlibrary_post', 'post_id'),
                    'post_id',
                ...
                ->addForeignKey(
                    $installer->getFkName('mageplaza_vlibrary_post_tag', 'tag_id', 'mageplaza_vlibrary_tag', 'tag_id'),
                    'tag_id',
        ...
        if (!$installer->tableExists('mageplaza_vlibrary_post_topic')) {
            $table = $installer->getConnection()
                ->newTable($installer->getTable('mageplaza_vlibrary_post_topic'))
                ->addColumn('topic_id', Table::TYPE_INTEGER, null, [
                    'unsigned' => true,
                    'primary'  => true,
                    'nullable' => false
                ...
                ->addIndex($installer->getIdxName('mageplaza_vlibrary_post_topic', ['post_id']), ['post_id'])
                ->addIndex($installer->getIdxName('mageplaza_vlibrary_post_topic', ['topic_id']), ['topic_id'])
                ->addForeignKey(
                    $installer->getFkName('mageplaza_vlibrary_post_topic', 'post_id', 'mageplaza_vlibrary_post', 'post_id'),
                    'post_id',
                    $installer->getTable('mageplaza_vlibrary_post'),
                    'post_id',
                    Table::ACTION_CASCADE
                ...
                ->addForeignKey(
                    $installer->getFkName('mageplaza_vlibrary_post_topic', 'topic_id', 'mageplaza_vlibrary_topic', 'topic_id'),
                    'topic_id',
        ...
        if (!$installer->tableExists('mageplaza_vlibrary_post_category')) {
            $table = $installer->getConnection()
                ->newTable($installer->getTable('mageplaza_vlibrary_post_category'))
                ->addColumn('category_id', Table::TYPE_INTEGER, null, [
                    'unsigned' => true,
                    'primary'  => true,
                    'nullable' => false
                ...
                ->addColumn('position', Table::TYPE_INTEGER, null, ['nullable' => false, 'default' => '0'], 'Position')
                ->addIndex($installer->getIdxName('mageplaza_vlibrary_post_category', ['category_id']), ['category_id'])
                ->addIndex($installer->getIdxName('mageplaza_vlibrary_post_category', ['post_id']), ['post_id'])
                ->addForeignKey(
                    $installer->getFkName(
                        'mageplaza_vlibrary_post_category',
                        'category_id',
                        'mageplaza_vlibrary_category',
                        'category_id'
                    ),
                    'category_id',
                ...
                ->addForeignKey(
                    $installer->getFkName('mageplaza_vlibrary_post_category', 'post_id', 'mageplaza_vlibrary_post', 'post_id'),
                    'post_id',
                    $installer->getTable('mageplaza_vlibrary_post'),
                    'post_id',
                    Table::ACTION_CASCADE
