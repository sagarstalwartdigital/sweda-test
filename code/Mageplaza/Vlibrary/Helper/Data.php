...
namespace Mageplaza\Vlibrary\Helper;
...
use Mageplaza\Vlibrary\Model\Author;
use Mageplaza\Vlibrary\Model\AuthorFactory;
use Mageplaza\Vlibrary\Model\Category;
use Mageplaza\Vlibrary\Model\CategoryFactory;
use Mageplaza\Vlibrary\Model\Config\Source\SideBarLR;
use Mageplaza\Vlibrary\Model\Post;
use Mageplaza\Vlibrary\Model\PostFactory;
use Mageplaza\Vlibrary\Model\ResourceModel\Author\Collection as AuthorCollection;
use Mageplaza\Vlibrary\Model\ResourceModel\Category\Collection as CategoryCollection;
use Mageplaza\Vlibrary\Model\ResourceModel\Post\Collection as PostCollection;
use Mageplaza\Vlibrary\Model\ResourceModel\Tag\Collection as TagCollection;
use Mageplaza\Vlibrary\Model\ResourceModel\Topic\Collection;
use Mageplaza\Vlibrary\Model\Tag;
use Mageplaza\Vlibrary\Model\TagFactory;
use Mageplaza\Vlibrary\Model\Topic;
use Mageplaza\Vlibrary\Model\TopicFactory;
use Mageplaza\Core\Helper\AbstractData as CoreHelper;

/**
 * Class Data
 * @package Mageplaza\Vlibrary\Helper
 */
class Data extends CoreHelper
{
    const CONFIG_MODULE_PATH = 'vlibrary';
     ...
     * @return mixed
     */
    public function getVlibraryConfig($code, $storeId = null)
    {
        $code = ($code !== '') ? '/' . $code : '';
    ...
    {
        return $this->getVlibraryConfig('seo/' . $code, $storeId);
    }
     ...
     * @return string
     */
    public function getVlibraryName($store = null)
    {
        return $this->getConfigGeneral('name', $store) ?: __('Vlibrary');
    }
    ...
    {
        return $this->getConfigGeneral('url_prefix', $store) ?: 'vlibrary';
    }
    ...
    public function getPostCollection($type = null, $id = null, $storeId = null)
    {
        ...
        switch ($type) {
            ...
            case self::TYPE_CATEGORY:
                $collection->join(
                    ['category' => $collection->getTable('mageplaza_vlibrary_post_category')],
            ...
            case self::TYPE_TAG:
                $collection->join(
                    ['tag' => $collection->getTable('mageplaza_vlibrary_post_tag')],
            ...
            case self::TYPE_TOPIC:
                $collection->join(
                    ['topic' => $collection->getTable('mageplaza_vlibrary_post_topic')],
     ...
     * @return string
     */
    public function getVlibraryUrl($urlKey = null, $type = null, $store = null)
    {
        if (is_object($urlKey)) {
    ...
    public function getDateFormat($date, $monthly = false)
    {
        ...
        $dateType = $this->getVlibraryConfig($monthly ? 'monthly_archive/date_type_monthly' : 'general/date_type');
