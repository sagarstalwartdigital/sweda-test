...
namespace Mageplaza\Vlibrary\Controller;
...
/**
 * Class Router
 * @package Mageplaza\Vlibrary\Controller
 */
class Router implements RouterInterface
{
    ...
    public function match(RequestInterface $request)
    {
        ...
        $request->setModuleName('mpvlibrary')
        ...
        if (!$controller) {
            $request->setControllerName('post')
                ->setActionName('index')
                ->setPathInfo('/mpvlibrary/post/index');
        ...
        $request->setControllerName($controller)
            ...
            ->setPathInfo('/mpvlibrary/' . $controller . '/' . $action);
