...
namespace Mageplaza\Vlibrary\Controller\Category;
...
/**
 * Class View
 * @package Mageplaza\Vlibrary\Controller\Category
 */
class View extends Action
{
    ...
    public function execute()
    {
        ...
        $category = $this->helperVlibrary->getFactoryByType(HelperVlibrary::TYPE_CATEGORY)->create()->load($id);

        if (!$this->helperVlibrary->checkStore($category)) {
