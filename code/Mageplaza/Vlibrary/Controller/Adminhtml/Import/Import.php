...
namespace Mageplaza\Vlibrary\Controller\Adminhtml\Import;

use Magento\Backend\App\Action;
use Magento\Backend\App\Action\Context;
use Magento\Framework\Registry;
use Mageplaza\Vlibrary\Helper\Data as VlibraryHelper;
use Mageplaza\Vlibrary\Model\Import\AheadWorksM1;
use Mageplaza\Vlibrary\Model\Import\MageFanM2;
use Mageplaza\Vlibrary\Model\Import\WordPress;

/**
 * Class Import
 * @package Mageplaza\Vlibrary\Controller\Adminhtml\Import
 */
class Import extends Action
{
    ...
    {
        $data = $this->_getSession()->getData('mageplaza_vlibrary_import_data');
        switch ($data['type']) {
            case 'wordpress':
    ...
    protected function processImport($object, $data)
    {
        ...
        if ($object->run($data, $connection)) {
            ...
            return $this->getResponse()->representJson(VlibraryHelper::jsonEncode($result));
        } else {
            $statisticHtml = $messagesBlock
