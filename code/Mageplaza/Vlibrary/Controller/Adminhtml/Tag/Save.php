    ...
    public function execute()
    {
        ...
        if ($data = $this->getRequest()->getPost('tag')) {
            ...
            $this->_eventManager->dispatch(
                'mageplaza_vlibrary_tag_prepare_save',
            ...
            try {
                ...
                $this->_session->setData('mageplaza_vlibrary_tag_data', false);

                if ($this->getRequest()->getParam('back')) {
                    $resultRedirect->setPath('mageplaza_vlibrary/*/edit', ['id' => $tag->getId(), '_current' => true]);
                } else {
            ...
            $this->_getSession()->setData('mageplaza_vlibrary_tag_data', $data);
