    ...
    public function execute()
    {
        ...
        if ($data = $this->getRequest()->getPost('topic')) {
            ...
            try {
                ...
                $this->_getSession()->setData('mageplaza_vlibrary_topic_data', false);

                if ($this->getRequest()->getParam('back')) {
                    $resultRedirect->setPath('mageplaza_vlibrary/*/edit', ['id' => $topic->getId(), '_current' => true]);
                } else {
            ...
            $this->_getSession()->setData('mageplaza_vlibrary_topic_data', $data);
