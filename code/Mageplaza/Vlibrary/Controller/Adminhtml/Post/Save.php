    ...
    public function execute()
    {
        ...
        if ($data = $this->getRequest()->getPost('post')) {
            ...
            $this->_eventManager->dispatch(
                'mageplaza_vlibrary_post_prepare_save',
            ...
            try {
                ...
                $this->_getSession()->setData('mageplaza_vlibrary_post_data', false);

                if ($this->getRequest()->getParam('back')) {
                    $resultRedirect->setPath('mageplaza_vlibrary/*/edit', ['id' => $post->getId(), '_current' => true]);
                } else {
            ...
            $this->_getSession()->setData('mageplaza_vlibrary_post_data', $data);
