...
use Mageplaza\Vlibrary\Model\ResourceModel\Post\CollectionFactory;
...
class Category extends AbstractModel
{
     ...
     * @var string
     */
    const CACHE_TAG = 'mageplaza_vlibrary_category';
     ...
     * @var string
     */
    protected $_cacheTag = 'mageplaza_vlibrary_category';
     ...
     * @var string
     */
    protected $_eventPrefix = 'mageplaza_vlibrary_category';

    /**
     * Post Collection
     *
     * @var \Mageplaza\Vlibrary\Model\ResourceModel\Post\Collection
     */
     ...
     *
     * @var \Mageplaza\Vlibrary\Model\ResourceModel\Post\CollectionFactory
     */
    ...
    {
        $this->_init('Mageplaza\Vlibrary\Model\ResourceModel\Category');
    }
    ...
    /**
     * move Vlibrary Category in tree
     *
     * @param $parentId
    ...
    public function move($parentId, $afterCategoryId)
    {
        try {
            ...
            throw new LocalizedException(
                __('Sorry, but we can\'t move the Vlibrary Category because we can\'t find the new parent Vlibrary Category you selected.'),
                $e
            );
        }
        ...
        if (!$this->getId()) {
            ...
            throw new LocalizedException(
                __('We can\'t perform this Vlibrary Category move operation because the parent Vlibrary Category matches the child Vlibrary Category.')
            );
        }
    ...
    public function getSelectedPostsCollection()
    {
        if (!$this->postCollection) {
            ...
            $collection->join(
                ['cat' => $this->getResource()->getTable('mageplaza_vlibrary_post_category')],
