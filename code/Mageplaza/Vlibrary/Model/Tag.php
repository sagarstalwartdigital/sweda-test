...
use Mageplaza\Vlibrary\Model\ResourceModel\Tag\CollectionFactory as TagCollectionFactory;
...
class Tag extends AbstractModel
{
     ...
     * @var string
     */
    const CACHE_TAG = 'mageplaza_vlibrary_tag';
     ...
     * @var string
     */
    protected $_cacheTag = 'mageplaza_vlibrary_tag';
     ...
     * @var string
     */
    protected $_eventPrefix = 'mageplaza_vlibrary_tag';
    ...
    {
        $this->_init('Mageplaza\Vlibrary\Model\ResourceModel\Tag');
    }
    ...
    public function getSelectedPostsCollection()
    {
        if ($this->postCollection === null) {
            ...
            $collection->join(
                ['post_tag' => $this->getResource()->getTable('mageplaza_vlibrary_post_tag')],
