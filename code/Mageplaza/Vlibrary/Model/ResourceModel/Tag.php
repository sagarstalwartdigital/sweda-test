...
class Tag extends AbstractDb
{
    ...
    public function __construct(
        ...
        $this->tagPostTable = $this->getTable('mageplaza_vlibrary_post_tag');
    }
    ...
    {
        $this->_init('mageplaza_vlibrary_tag', 'tag_id');
    }
     ...
     * @return array
     */
    public function getPostsPosition(\Mageplaza\Vlibrary\Model\Tag $tag)
    {
     ...
     * @return $this
     */
    protected function savePostRelation(\Mageplaza\Vlibrary\Model\Tag $tag)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'mageplaza_vlibrary_tag_change_posts',
