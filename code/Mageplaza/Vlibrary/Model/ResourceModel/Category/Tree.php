...
namespace Mageplaza\Vlibrary\Model\ResourceModel\Category;
...
use Mageplaza\Vlibrary\Model\ResourceModel\Category;

/**
 * Class Tree
 * @package Mageplaza\Vlibrary\Model\ResourceModel\Category
 */
class Tree extends Dbp
{
     ...
     * Collection factory
     *
     * @var \Mageplaza\Vlibrary\Model\ResourceModel\Category\CollectionFactory
     */
    public $collectionFactory;

    /**
     * Vlibrary Category Resource instance
     *
     * @var \Mageplaza\Vlibrary\Model\ResourceModel\Category
     */
     ...
     *
     * @var \Mageplaza\Vlibrary\Model\ResourceModel\Category\Collection
     */
    public $collection;

    /**
     * Inactive Vlibrary Category Ids
     *
     * @var array
     */
     ...
     * @param \Mageplaza\Vlibrary\Model\ResourceModel\Category\CollectionFactory $collectionFactory
    ...
    public function __construct(
        ...
        parent::__construct(
            $coreResource->getConnection('mageplaza_vlibrary_write'),
            $coreResource->getTableName('mageplaza_vlibrary_category'),
            [
    ...
    public function initInactiveCategoryIds()
    {
        ...
        $this->eventManager->dispatch('mageplaza_vlibrary_category_tree_init_inactive_category_ids', ['tree' => $this]);
    ...
    /**
     * Return disable Vlibrary Category ids
     *
     * @param Collection $collection
     * @param array $allIds
     *
    ...
    /**
     * Retrieve inactive Vlibrary Category item ids
     *
     * @param Collection $collection
     * @param int $storeId
     *
    ...
    /**
     * Check is Vlibrary Category items active
     *
     * @param int $id
     *
     * @return boolean
    ...
    {
        $this->cache->clean([\Mageplaza\Vlibrary\Model\Category::CACHE_TAG]);

        return $this;
    }

    /**
     * Load whole Vlibrary Category tree, that will include specified Categories ids.
     *
     * @param array $ids
    ...
    /**
     * Get real existing Vlibrary Category ids by specified ids
     *
     * @param array $ids
     *
     * @return array
