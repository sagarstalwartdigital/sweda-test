...
class Collection extends AbstractCollection
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'mageplaza_vlibrary_category_collection';
    ...
    {
        $this->_init('Mageplaza\Vlibrary\Model\Category', 'Mageplaza\Vlibrary\Model\ResourceModel\Category');
    }
