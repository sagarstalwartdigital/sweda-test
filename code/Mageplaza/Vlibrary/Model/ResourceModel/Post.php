...
class Post extends AbstractDb
{
    ...
    /**
     * Vlibrary Category relation model
     *
     * @var string
     */
    ...
    public function __construct(
        ...
        $this->postTagTable = $this->getTable('mageplaza_vlibrary_post_tag');
        $this->postTopicTable = $this->getTable('mageplaza_vlibrary_post_topic');
        $this->postCategoryTable = $this->getTable('mageplaza_vlibrary_post_category');
        $this->postProductTable = $this->getTable('mageplaza_vlibrary_post_product');
    }
    ...
    {
        $this->_init('mageplaza_vlibrary_post', 'post_id');
    }
     ...
     * @throws \Magento\Framework\Exception\LocalizedException
     */
    public function saveTagRelation(\Mageplaza\Vlibrary\Model\Post $post)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'mageplaza_vlibrary_post_change_tags',
     ...
     * @throws \Magento\Framework\Exception\LocalizedException
     */
    public function saveTopicRelation(\Mageplaza\Vlibrary\Model\Post $post)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'mageplaza_vlibrary_post_change_topics',
     ...
     * @throws \Magento\Framework\Exception\LocalizedException
     */
    public function saveCategoryRelation(\Mageplaza\Vlibrary\Model\Post $post)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'mageplaza_vlibrary_post_change_categories',
     ...
     * @return array
     */
    public function getCategoryIds(\Mageplaza\Vlibrary\Model\Post $post)
    {
        $adapter = $this->getConnection();
     ...
     * @return array
     */
    public function getTagIds(\Mageplaza\Vlibrary\Model\Post $post)
    {
        $adapter = $this->getConnection();
        $select = $adapter->select()->from(
            $this->postTagTable,
     ...
     * @return array
     */
    public function getTopicIds(\Mageplaza\Vlibrary\Model\Post $post)
    {
        $adapter = $this->getConnection();
     ...
     * @return $this
     */
    public function saveProductRelation(\Mageplaza\Vlibrary\Model\Post $post)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'mageplaza_vlibrary_post_change_products',
     ...
     * @return array
     */
    public function getProductsPosition(\Mageplaza\Vlibrary\Model\Post $post)
    {
    ...
    public function saveAuthor()
    {
        ...
        /** @var \Mageplaza\Vlibrary\Model\Author $author */
