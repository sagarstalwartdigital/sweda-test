...
class Category extends AbstractDb
{
    ...
    public function __construct(
        ...
        $this->categoryPostTable = $this->getTable('mageplaza_vlibrary_post_category');
    }
    ...
    {
        $this->_init('mageplaza_vlibrary_category', 'category_id');
    }

    /**
     * Retrieves Vlibrary Category Name from DB by passed id.
     *
     * @param $id
     *
     * @return string
    ...
    protected function _beforeSave(AbstractModel $object)
    {
        ...
        /** @var \Mageplaza\Vlibrary\Model\Category $object */
    ...
    protected function getMaxPosition($path)
    {
        ...
        $select = $adapter->select()->from(
            $this->getTable('mageplaza_vlibrary_category'),
            'MAX(' . $positionField . ')'
        )->where(
    ...
    /**
     * @param \Mageplaza\Vlibrary\Model\Category $category
     * @param \Mageplaza\Vlibrary\Model\Category $newParent
    ...
    public function changeParent(
        \Mageplaza\Vlibrary\Model\Category $category,
        \Mageplaza\Vlibrary\Model\Category $newParent,
        ...
        /**
         * Decrease children count for all old Vlibrary Category parent Categories
         */
        $adapter->update(
            $table,
        ...
        /**
         * Increase children count for new Vlibrary Category parents
         */
        $adapter->update(
            $table,
            ['children_count' => 'children_count + ' . $childrenCount],
        ...
        /**
         * Update moved Vlibrary Category data
         */
        $data = [
            'path'      => $newPath,
            'level'     => $newLevel,
        ...
        /** Update Vlibrary Category object to new data */
     ...
     * @return array
     */
    public function getPostsPosition(\Mageplaza\Vlibrary\Model\Category $category)
    {
        $select = $this->getConnection()->select()->from(
     ...
     * @return $this
     */
    public function savePostRelation(\Mageplaza\Vlibrary\Model\Category $category)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'mageplaza_vlibrary_category_change_posts',
