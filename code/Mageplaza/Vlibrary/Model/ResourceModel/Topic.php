...
class Topic extends AbstractDb
{
    ...
    public function __construct(
        ...
        $this->topicPostTable = $this->getTable('mageplaza_vlibrary_post_topic');
    }
    ...
    {
        $this->_init('mageplaza_vlibrary_topic', 'topic_id');
    }
     ...
     * after save callback
     *
     * @param AbstractModel|\Mageplaza\Vlibrary\Model\Topic $object
     *
     * @return $this
     */
    ...
    /**
     * @param \Mageplaza\Vlibrary\Model\Topic $topic
     *
     * @return array
     */
    public function getPostsPosition(\Mageplaza\Vlibrary\Model\Topic $topic)
    {
     ...
     * @return $this
     */
    protected function savePostRelation(\Mageplaza\Vlibrary\Model\Topic $topic)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'mageplaza_vlibrary_topic_change_posts',
