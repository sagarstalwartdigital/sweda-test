...
namespace Mageplaza\Vlibrary\Model\ResourceModel\Comment\Grid;
...
/**
 * Class Collection
 * @package Mageplaza\Vlibrary\Model\ResourceModel\Comment\Grid
 */
class Collection extends SearchResult
{
    ...
    public function __construct(
        ...
        $mainTable = 'mageplaza_vlibrary_comment',
        $resourceModel = '\Mageplaza\Vlibrary\Model\ResourceModel\Comment'
    ) {
    ...
    public function addPostName()
    {
        $this->getSelect()->joinLeft(
            ['mp' => $this->getTable('mageplaza_vlibrary_post')],
