...
namespace Mageplaza\Vlibrary\Model\ResourceModel\Topic;

use Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection;

/**
 * Class Collection
 * @package Mageplaza\Vlibrary\Model\ResourceModel\Topic
 */
class Collection extends AbstractCollection
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'mageplaza_vlibrary_topic_collection';
    ...
    {
        $this->_init('Mageplaza\Vlibrary\Model\Topic', 'Mageplaza\Vlibrary\Model\ResourceModel\Topic');
    }
