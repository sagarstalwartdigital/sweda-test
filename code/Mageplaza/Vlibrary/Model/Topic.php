...
class Topic extends AbstractModel
{
     ...
     * @var string
     */
    const CACHE_TAG = 'mageplaza_vlibrary_topic';
     ...
     * @var string
     */
    protected $_cacheTag = 'mageplaza_vlibrary_topic';
     ...
     * @var string
     */
    protected $_eventPrefix = 'mageplaza_vlibrary_topic';
    ...
    {
        $this->_init('Mageplaza\Vlibrary\Model\ResourceModel\Topic');
    }
