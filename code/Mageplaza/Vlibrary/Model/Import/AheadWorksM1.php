...
class AheadWorksM1 extends AbstractImport
{
     ...
     * @var string
     */
    const TABLE_POST = 'aw_vlibrary';
    /**
     * AheadworksM1 Tag table name
     *
     * @var string
     */
    const TABLE_TAG = 'aw_vlibrary_tags';
    /**
     * AheadworksM1 Category table name
     *
     * @var string
     */
    const TABLE_CATEGORY = 'aw_vlibrary_cat';
    /**
     * AheadworksM1 Comment table name
     *
     * @var string
     */
    const TABLE_COMMENT = 'aw_vlibrary_comment';
    /**
     * AheadworksM1 Category-Post Relationship table name
     *
     * @var string
     */
    const TABLE_CATEGORY_POST = 'aw_vlibrary_post_cat';
                ...
                foreach ($tagIds as $id) {
                    try {
                        ...
                        $this->_resourceConnection->getConnection()
                            ->insert(
                                $this->_resourceConnection->getTableName('mageplaza_vlibrary_post_tag'),
    ...
    protected function _importCategories($data, $connection)
    {
        ...
        if ($isReplace && isset($sourceItems)) {
            ...
            $this->_importCategoryPost($data, $connection, $oldCategoryIds, 'mageplaza_vlibrary_post_category');
        }
