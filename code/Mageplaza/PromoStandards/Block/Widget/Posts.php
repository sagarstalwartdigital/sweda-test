...
namespace Mageplaza\PromoStandards\Block\Widget;
...
/**
 * Class Posts
 * @package Mageplaza\PromoStandards\Block\Widget
 */
class Posts extends Frontend implements BlockInterface
{
    ...
    /**
     * @return \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection|\Mageplaza\PromoStandards\Model\ResourceModel\Post\Collection
     */
    ...
    /**
     * @return \Mageplaza\PromoStandards\Helper\Data
     */
     ...
     * @return string
     */
    public function getPromoStandardsUrl($code)
    {
        return $this->helperData->getPromoStandardsUrl($code);
    }
}
