...
namespace Mageplaza\PromoStandards\Block\Adminhtml\Tag;
...
/**
 * Class Edit
 * @package Mageplaza\PromoStandards\Block\Adminhtml\Tag
 */
class Edit extends Container
{
    ...
    public function getHeaderText()
    {
        ...
        $tag = $this->coreRegistry->registry('mageplaza_promostandards_tag');
        if ($tag->getId()) {
