...
namespace Mageplaza\PromoStandards\Block\Adminhtml\Tag\Edit\Tab;
...
/**
 * Class Post
 * @package Mageplaza\PromoStandards\Block\Adminhtml\Tag\Edit\Tab
 */
class Post extends Extended implements TabInterface
{
     ...
     * @param \Mageplaza\PromoStandards\Model\ResourceModel\Post\CollectionFactory $postCollectionFactory
     * @param array $data
     */
    ...
    {
        /** @var \Mageplaza\PromoStandards\Model\ResourceModel\Post\Collection $collection */
        $collection = $this->postCollectionFactory->create();
        $collection->getSelect()->joinLeft(
            ['related' => $collection->getTable('mageplaza_promostandards_post_tag')],
    ...
    /**
     * @param \Mageplaza\PromoStandards\Model\Post|\Magento\Framework\Object $item
     *
     * @return string
     */
    ...
    /**
     * @return \Mageplaza\PromoStandards\Model\Tag
     */
    public function getTag()
    {
        return $this->coreRegistry->registry('mageplaza_promostandards_tag');
    }
    ...
    {
        return $this->getUrl('mageplaza_promostandards/tag/posts', ['_current' => true]);
    }
