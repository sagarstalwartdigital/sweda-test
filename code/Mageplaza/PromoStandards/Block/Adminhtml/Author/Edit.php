...
namespace Mageplaza\PromoStandards\Block\Adminhtml\Author;
...
/**
 * Class Edit
 * @package Mageplaza\PromoStandards\Block\Adminhtml\Author
 */
class Edit extends Container
{
    ...
    public function getHeaderText()
    {
        ...
        $author = $this->coreRegistry->registry('mageplaza_promostandards_author');
        if ($author->getId()) {
