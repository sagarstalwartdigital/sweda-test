...
use Mageplaza\PromoStandards\Model\ResourceModel\Category\Tree as PromoStandardsTreeResource;
...
class Tree extends \Magento\Catalog\Block\Adminhtml\Category\Tree
{
     ...
     */
    protected $_promostandardsStore;
     ...
     * @param \Mageplaza\PromoStandards\Model\ResourceModel\Category\Tree $promostandardsCategoryTree
     * @param \Mageplaza\PromoStandards\Model\CategoryFactory $promostandardsCategoryFactory
     * @param array $data
     */
    public function __construct(
        ...
        PromoStandardsTreeResource $promostandardsCategoryTree,
        CategoryFactory $promostandardsCategoryFactory,
        array $data = []
    ) {
        parent::__construct(
            $context,
    ...
    {
        return $this->getUrl('mageplaza_promostandards/category/jsonTree');
    }
    ...
    {
        return $this->getUrl('mageplaza_promostandards/category/move');
    }
    ...
    {
        $this->_promostandardsStore = $store;
    ...
    protected function _getNodeJson($node, $level = 0)
    {
        ...
        if (!empty($storeIds) && !in_array(0, $storeIds) && !is_null($this->_promostandardsStore) && !in_array(
            $this->_promostandardsStore,
            $storeIds
        )) {
            return null;
        }
