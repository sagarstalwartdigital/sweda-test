...
namespace Mageplaza\PromoStandards\Block\Adminhtml\Category\Edit\Tab;
...
/**
 * Class Post
 * @package Mageplaza\PromoStandards\Block\Adminhtml\Category\Edit\Tab
 */
class Post extends Extended implements TabInterface
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(
            ['related' => $collection->getTable('mageplaza_promostandards_post_category')],
    ...
    /**
     * @return \Mageplaza\PromoStandards\Model\Category
     */
    ...
    {
        return $this->getUrl('mageplaza_promostandards/category/posts', ['_current' => true]);
    }
