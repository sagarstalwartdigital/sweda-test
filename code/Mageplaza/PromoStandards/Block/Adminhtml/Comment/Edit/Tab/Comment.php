...
namespace Mageplaza\PromoStandards\Block\Adminhtml\Comment\Edit\Tab;
...
/**
 * Class Comment
 * @package Mageplaza\PromoStandards\Block\Adminhtml\Comment\Edit\Tab
 */
class Comment extends Generic implements TabInterface
{
    ...
    {
        $comment = $this->_coreRegistry->registry('mageplaza_promostandards_comment');
        ...
        $postText = '<a href="' . $this->getUrl('mageplaza_promostandards/post/edit', ['id' => $comment->getPostId()])
