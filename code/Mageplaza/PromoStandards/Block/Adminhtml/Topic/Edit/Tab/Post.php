...
namespace Mageplaza\PromoStandards\Block\Adminhtml\Topic\Edit\Tab;
...
/**
 * Class Post
 * @package Mageplaza\PromoStandards\Block\Adminhtml\Topic\Edit\Tab
 */
class Post extends Extended implements TabInterface
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(
            ['related' => $collection->getTable('mageplaza_promostandards_post_topic')],
    ...
    /**
     * @return \Mageplaza\PromoStandards\Model\Topic
     */
    public function getTopic()
    {
        return $this->coreRegistry->registry('mageplaza_promostandards_topic');
    }
    ...
    {
        return $this->getUrl('mageplaza_promostandards/topic/posts', ['_current' => true]);
    }
