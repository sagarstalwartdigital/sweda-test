...
namespace Mageplaza\PromoStandards\Block\Adminhtml\Topic;
...
/**
 * Class Edit
 * @package Mageplaza\PromoStandards\Block\Adminhtml\Topic
 */
class Edit extends Container
{
    ...
    public function getHeaderText()
    {
        ...
        $topic = $this->coreRegistry->registry('mageplaza_promostandards_topic');
        if ($topic->getId()) {
