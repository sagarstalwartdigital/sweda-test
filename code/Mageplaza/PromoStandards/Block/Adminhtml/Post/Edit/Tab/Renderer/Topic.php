...
use Mageplaza\PromoStandards\Model\ResourceModel\Topic\CollectionFactory as PromoStandardsTopicCollectionFactory;
...
{
    /**
     * @var \Mageplaza\PromoStandards\Model\ResourceModel\Topic\CollectionFactory
     */
     ...
     * @param PromoStandardsTopicCollectionFactory $collectionFactory
    ...
    public function __construct(
        ...
        Escaper $escaper,
        PromoStandardsTopicCollectionFactory $collectionFactory,
    ...
    public function getElementHtml()
    {
        ...
        $html .= '<div id="promostandards-topic-select" class="admin__field" data-bind="scope:\'promostandardsTopic\'" data-index="index">';
    ...
    {
        $isNotAllowed = !$this->authorization->isAllowed('Mageplaza_PromoStandards::topic');
    ...
    {
        /* @var $collection \Mageplaza\PromoStandards\Model\ResourceModel\Topic\Collection */
    ...
    /**
     * Attach PromoStandards Topic suggest widget initialization
     *
     * @return string
     */
        ...
        $html = '<script type="text/x-magento-init">
            {
                                ...
                                "children": {
                                    "promostandards_select_topic": {
                                        ...
                                        "config": {
                                            ...
                                            "config": {
                                                "dataScope": "promostandards_select_topic",
                                                "sortOrder": 10
                                            }
                                        }
                                    }
                ...
                ['handle' => 'mageplaza_promostandards_topic_create', 'buttons' => 1]) . '",
                                        "autoRender": false,
                                        "ns": "promostandards_new_topic_form",
                                        "externalProvider": "promostandards_new_topic_form.new_topic_form_data_source",
