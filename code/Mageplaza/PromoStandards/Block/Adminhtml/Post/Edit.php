...
namespace Mageplaza\PromoStandards\Block\Adminhtml\Post;
...
/**
 * Class Edit
 * @package Mageplaza\PromoStandards\Block\Adminhtml\Post
 */
class Edit extends Container
{
    ...
    public function getHeaderText()
    {
        ...
        $post = $this->coreRegistry->registry('mageplaza_promostandards_post');
        if ($post->getId()) {
