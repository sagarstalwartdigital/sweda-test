...
class Frontend extends Template
{
    ...
    /**
     * @type \Mageplaza\PromoStandards\Helper\Data
     */
    public $helperData;
    ...
    /**
     * @var \Mageplaza\PromoStandards\Model\LikeFactory
     */
    public $likeFactory;
    ...
    public function getPostCategoryHtml($post)
    {
        ...
        foreach ($categories as $_cat) {
            $categoryHtml[] = '<a class="mp-info" href="' . $this->helperData->getPromoStandardsUrl(
                $_cat,
                Data::TYPE_CATEGORY
            ) . '">' . $_cat->getName() . '</a>';
        }
    ...
    {
        return $this->getViewFileUrl('Mageplaza_PromoStandards::media/images/mageplaza-logo-default.png');
    }
    ...
    {
        return $this->getViewFileUrl('Mageplaza_PromoStandards::media/images/no-artist-image.jpg');
    }
}
