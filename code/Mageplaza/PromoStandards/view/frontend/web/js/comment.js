...
require([
            ...
            likeEl.click(function () {
                ...
                if (isLogged === 'Yes') {
                    ...
                    if ($(this).attr('click') === '1') {
                        if ($(this).hasClass('mppromostandards-liked')) {
                            $(this).css('color', '#333333');
                            likeCount--;
                            $(this).find('span').text((likeCount === 0) ? "" : likeCount);
                            $(this).removeClass('mppromostandards-liked')

                        } else {
                            likeCount++;
                            $(this).find('span').text(likeCount);
                            $(this).css('color', likedColor);
                            $(this).addClass('mppromostandards-liked')
                        }
                        $.ajax({
                            type: "POST",
    ...
    function displayComment(cmt, isReply) {
        ...
        var cmtRow = '<li id="cmt-id-' + cmt.cmt_id + '" class="default-cmt__content__cmt-content__cmt-row cmt-row-' + cmt.cmt_id + ' cmt-row col-xs-12 '
            ...
            + '</p> </div> <div class="cmt-row__cmt-interactions interactions"> <div class="interactions__btn-actions"> <a class="interactions__btn-actions action btn-like mppromostandards-like" data-cmt-id="'
