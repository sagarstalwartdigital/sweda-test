...
namespace Mageplaza\PromoStandards\Controller\Tag;
...
/**
 * Class View
 * @package Mageplaza\PromoStandards\Controller\Tag
 */
class View extends Action
{
    ...
    public function execute()
    {
        ...
        $tag = $this->helperPromoStandards->getFactoryByType(HelperPromoStandards::TYPE_TAG)->create()->load($id);

        if (!$this->helperPromoStandards->checkStore($tag)) {
