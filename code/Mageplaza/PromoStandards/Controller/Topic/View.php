...
namespace Mageplaza\PromoStandards\Controller\Topic;
...
/**
 * Class View
 * @package Mageplaza\PromoStandards\Controller\Topic
 */
class View extends Action
{
    ...
    public function execute()
    {
        ...
        $topic = $this->helperPromoStandards->getFactoryByType(HelperPromoStandards::TYPE_TOPIC)->create()->load($id);
