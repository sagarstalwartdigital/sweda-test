...
class Edit extends Action
{
    ...
    {
        $data = $this->_session->getData('mageplaza_promostandards_import_data');

        $this->registry->register('mageplaza_promostandards_import', $data);

        /** @var \Magento\Backend\Model\View\Result\Page|\Magento\Framework\View\Result\Page $resultPage */
        $resultPage = $this->resultPageFactory->create();
        $resultPage->setActiveMenu('Mageplaza_PromoStandards::import');
