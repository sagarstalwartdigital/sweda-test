...
use Mageplaza\PromoStandards\Model\Import\AheadWorksM1;
use Mageplaza\PromoStandards\Model\Import\MageFanM2;
use Mageplaza\PromoStandards\Model\Import\WordPress;
...
class Import extends Action
{
    ...
    {
        $data = $this->_getSession()->getData('mageplaza_promostandards_import_data');
        switch ($data['type']) {
            case 'wordpress':
