    ...
    public function execute()
    {
        ...
        if ($data = $this->getRequest()->getPost('post')) {
            ...
            $this->_eventManager->dispatch(
                'mageplaza_promostandards_post_prepare_save',
            ...
            try {
                ...
                $this->_getSession()->setData('mageplaza_promostandards_post_data', false);

                if ($this->getRequest()->getParam('back')) {
                    $resultRedirect->setPath('mageplaza_promostandards/*/edit', ['id' => $post->getId(), '_current' => true]);
                } else {
            ...
            $this->_getSession()->setData('mageplaza_promostandards_post_data', $data);
