...
use Mageplaza\PromoStandards\Model\ResourceModel\Comment\CollectionFactory;
...
class Edit extends Comment
{
    ...
    public function execute()
    {
        ...
        $data = $this->_session->getData('mageplaza_promostandards_comment_data', true);
        ...
        $resultPage->setActiveMenu('Mageplaza_PromoStandards::comment');
