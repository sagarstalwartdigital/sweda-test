...
class SuggestCategories extends Category
{
    ...
    /**
     * PromoStandards Category list suggestion based on already entered symbols
     *
     * @return \Magento\Framework\Controller\Result\Json
     */
    public function execute()
    {
        /** @var \Mageplaza\PromoStandards\Block\Adminhtml\Category\Tree $treeBlock */
        $treeBlock = $this->layoutFactory->create()->createBlock('Mageplaza\PromoStandards\Block\Adminhtml\Category\Tree');
