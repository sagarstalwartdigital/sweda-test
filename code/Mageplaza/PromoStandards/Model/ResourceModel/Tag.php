...
class Tag extends AbstractDb
{
    ...
    public function __construct(
        ...
        $this->tagPostTable = $this->getTable('mageplaza_promostandards_post_tag');
    }
    ...
    {
        $this->_init('mageplaza_promostandards_tag', 'tag_id');
    }
    ...
    /**
     * @param \Mageplaza\PromoStandards\Model\Tag $tag
     *
     * @return array
     */
    public function getPostsPosition(\Mageplaza\PromoStandards\Model\Tag $tag)
    {
     ...
     * @return $this
     */
    protected function savePostRelation(\Mageplaza\PromoStandards\Model\Tag $tag)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'mageplaza_promostandards_tag_change_posts',
