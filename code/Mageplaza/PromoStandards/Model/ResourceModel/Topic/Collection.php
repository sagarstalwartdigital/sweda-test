...
namespace Mageplaza\PromoStandards\Model\ResourceModel\Topic;

use Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection;

/**
 * Class Collection
 * @package Mageplaza\PromoStandards\Model\ResourceModel\Topic
 */
class Collection extends AbstractCollection
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'mageplaza_promostandards_topic_collection';
    ...
    {
        $this->_init('Mageplaza\PromoStandards\Model\Topic', 'Mageplaza\PromoStandards\Model\ResourceModel\Topic');
    }
