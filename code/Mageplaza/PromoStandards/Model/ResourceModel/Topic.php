...
class Topic extends AbstractDb
{
    ...
    public function __construct(
        ...
        $this->topicPostTable = $this->getTable('mageplaza_promostandards_post_topic');
    }
    ...
    {
        $this->_init('mageplaza_promostandards_topic', 'topic_id');
    }
     ...
     * after save callback
     *
     * @param AbstractModel|\Mageplaza\PromoStandards\Model\Topic $object
     *
     * @return $this
     */
    ...
    /**
     * @param \Mageplaza\PromoStandards\Model\Topic $topic
     *
     * @return array
     */
    public function getPostsPosition(\Mageplaza\PromoStandards\Model\Topic $topic)
    {
     ...
     * @return $this
     */
    protected function savePostRelation(\Mageplaza\PromoStandards\Model\Topic $topic)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'mageplaza_promostandards_topic_change_posts',
