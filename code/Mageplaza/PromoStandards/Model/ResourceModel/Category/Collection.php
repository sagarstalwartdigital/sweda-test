...
class Collection extends AbstractCollection
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'mageplaza_promostandards_category_collection';
    ...
    {
        $this->_init('Mageplaza\PromoStandards\Model\Category', 'Mageplaza\PromoStandards\Model\ResourceModel\Category');
    }
