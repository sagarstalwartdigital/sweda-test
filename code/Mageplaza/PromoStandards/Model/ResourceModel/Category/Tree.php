...
namespace Mageplaza\PromoStandards\Model\ResourceModel\Category;
...
use Mageplaza\PromoStandards\Model\ResourceModel\Category;

/**
 * Class Tree
 * @package Mageplaza\PromoStandards\Model\ResourceModel\Category
 */
class Tree extends Dbp
{
    ...
    /**
     * PromoStandards Category Resource instance
     *
     * @var \Mageplaza\PromoStandards\Model\ResourceModel\Category
     */
     ...
     *
     * @var \Mageplaza\PromoStandards\Model\ResourceModel\Category\Collection
     */
    public $collection;

    /**
     * Inactive PromoStandards Category Ids
     *
     * @var array
     */
    ...
    public function __construct(
        ...
        parent::__construct(
            $coreResource->getConnection('mageplaza_promostandards_write'),
            $coreResource->getTableName('mageplaza_promostandards_category'),
            [
    ...
    public function initInactiveCategoryIds()
    {
        ...
        $this->eventManager->dispatch('mageplaza_promostandards_category_tree_init_inactive_category_ids', ['tree' => $this]);
    ...
    /**
     * Return disable PromoStandards Category ids
     *
     * @param Collection $collection
     * @param array $allIds
     *
    ...
    /**
     * Retrieve inactive PromoStandards Category item ids
     *
     * @param Collection $collection
     * @param int $storeId
     *
    ...
    /**
     * Check is PromoStandards Category items active
     *
     * @param int $id
     *
     * @return boolean
    ...
    {
        $this->cache->clean([\Mageplaza\PromoStandards\Model\Category::CACHE_TAG]);

        return $this;
    }

    /**
     * Load whole PromoStandards Category tree, that will include specified Categories ids.
     *
     * @param array $ids
    ...
    /**
     * Get real existing PromoStandards Category ids by specified ids
     *
     * @param array $ids
     *
     * @return array
