...
class Category extends AbstractDb
{
    ...
    public function __construct(
        ...
        $this->categoryPostTable = $this->getTable('mageplaza_promostandards_post_category');
    }
    ...
    {
        $this->_init('mageplaza_promostandards_category', 'category_id');
    }

    /**
     * Retrieves PromoStandards Category Name from DB by passed id.
     *
     * @param $id
     *
     * @return string
    ...
    protected function _beforeSave(AbstractModel $object)
    {
        ...
        /** @var \Mageplaza\PromoStandards\Model\Category $object */
    ...
    protected function getMaxPosition($path)
    {
        ...
        $select = $adapter->select()->from(
            $this->getTable('mageplaza_promostandards_category'),
            'MAX(' . $positionField . ')'
        )->where(
    ...
    /**
     * @param \Mageplaza\PromoStandards\Model\Category $category
     * @param \Mageplaza\PromoStandards\Model\Category $newParent
    ...
    public function changeParent(
        \Mageplaza\PromoStandards\Model\Category $category,
        \Mageplaza\PromoStandards\Model\Category $newParent,
        ...
        /**
         * Decrease children count for all old PromoStandards Category parent Categories
         */
        $adapter->update(
            $table,
        ...
        /**
         * Increase children count for new PromoStandards Category parents
         */
        $adapter->update(
            $table,
            ['children_count' => 'children_count + ' . $childrenCount],
        ...
        /**
         * Update moved PromoStandards Category data
         */
        $data = [
            'path'      => $newPath,
            'level'     => $newLevel,
        ...
        /** Update PromoStandards Category object to new data */
     ...
     * @return array
     */
    public function getPostsPosition(\Mageplaza\PromoStandards\Model\Category $category)
    {
        $select = $this->getConnection()->select()->from(
     ...
     * @return $this
     */
    public function savePostRelation(\Mageplaza\PromoStandards\Model\Category $category)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'mageplaza_promostandards_category_change_posts',
