...
namespace Mageplaza\PromoStandards\Model\ResourceModel\Comment\Grid;
...
/**
 * Class Collection
 * @package Mageplaza\PromoStandards\Model\ResourceModel\Comment\Grid
 */
class Collection extends SearchResult
{
    ...
    public function __construct(
        ...
        $mainTable = 'mageplaza_promostandards_comment',
        $resourceModel = '\Mageplaza\PromoStandards\Model\ResourceModel\Comment'
    ) {
    ...
    public function addPostName()
    {
        $this->getSelect()->joinLeft(
            ['mp' => $this->getTable('mageplaza_promostandards_post')],
