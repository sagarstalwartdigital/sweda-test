...
class Post extends AbstractDb
{
    ...
    /**
     * PromoStandards Category relation model
     *
     * @var string
     */
    ...
    public function __construct(
        ...
        $this->postTagTable = $this->getTable('mageplaza_promostandards_post_tag');
        $this->postTopicTable = $this->getTable('mageplaza_promostandards_post_topic');
        $this->postCategoryTable = $this->getTable('mageplaza_promostandards_post_category');
        $this->postProductTable = $this->getTable('mageplaza_promostandards_post_product');
    }
    ...
    {
        $this->_init('mageplaza_promostandards_post', 'post_id');
    }
    ...
    /**
     * @param \Mageplaza\PromoStandards\Model\Post $post
     *
     * @return $this
     * @throws \Magento\Framework\Exception\LocalizedException
     */
    public function saveTagRelation(\Mageplaza\PromoStandards\Model\Post $post)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'mageplaza_promostandards_post_change_tags',
     ...
     * @throws \Magento\Framework\Exception\LocalizedException
     */
    public function saveTopicRelation(\Mageplaza\PromoStandards\Model\Post $post)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'mageplaza_promostandards_post_change_topics',
     ...
     * @throws \Magento\Framework\Exception\LocalizedException
     */
    public function saveCategoryRelation(\Mageplaza\PromoStandards\Model\Post $post)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'mageplaza_promostandards_post_change_categories',
     ...
     * @return array
     */
    public function getCategoryIds(\Mageplaza\PromoStandards\Model\Post $post)
    {
        $adapter = $this->getConnection();
     ...
     * @return array
     */
    public function getTagIds(\Mageplaza\PromoStandards\Model\Post $post)
    {
        $adapter = $this->getConnection();
        $select = $adapter->select()->from(
            $this->postTagTable,
     ...
     * @return array
     */
    public function getTopicIds(\Mageplaza\PromoStandards\Model\Post $post)
    {
        $adapter = $this->getConnection();
     ...
     * @return $this
     */
    public function saveProductRelation(\Mageplaza\PromoStandards\Model\Post $post)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'mageplaza_promostandards_post_change_products',
     ...
     * @return array
     */
    public function getProductsPosition(\Mageplaza\PromoStandards\Model\Post $post)
    {
