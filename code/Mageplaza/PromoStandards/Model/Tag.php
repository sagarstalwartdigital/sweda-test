...
use Mageplaza\PromoStandards\Model\ResourceModel\Tag\CollectionFactory as TagCollectionFactory;
...
class Tag extends AbstractModel
{
     ...
     * @var string
     */
    const CACHE_TAG = 'mageplaza_promostandards_tag';
     ...
     * @var string
     */
    protected $_cacheTag = 'mageplaza_promostandards_tag';
     ...
     * @var string
     */
    protected $_eventPrefix = 'mageplaza_promostandards_tag';
    ...
    {
        $this->_init('Mageplaza\PromoStandards\Model\ResourceModel\Tag');
    }
    ...
    public function getSelectedPostsCollection()
    {
        if ($this->postCollection === null) {
            ...
            $collection->join(
                ['post_tag' => $this->getResource()->getTable('mageplaza_promostandards_post_tag')],
