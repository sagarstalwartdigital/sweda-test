...
class Author extends AbstractModel
{
     ...
     * @inheritdoc
     */
    const CACHE_TAG = 'mageplaza_promostandards_author';
    ...
    {
        $this->_init('Mageplaza\PromoStandards\Model\ResourceModel\Author');
    }
    ...
    {
        return $this->helperData->getPromoStandardsUrl($this, Data::TYPE_AUTHOR);
    }
}
