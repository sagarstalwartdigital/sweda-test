...
class Topic extends AbstractModel
{
     ...
     * @var string
     */
    const CACHE_TAG = 'mageplaza_promostandards_topic';
     ...
     * @var string
     */
    protected $_cacheTag = 'mageplaza_promostandards_topic';
     ...
     * @var string
     */
    protected $_eventPrefix = 'mageplaza_promostandards_topic';
    ...
    {
        $this->_init('Mageplaza\PromoStandards\Model\ResourceModel\Topic');
    }
