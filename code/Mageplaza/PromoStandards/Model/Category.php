...
class Category extends AbstractModel
{
     ...
     * @var string
     */
    const CACHE_TAG = 'mageplaza_promostandards_category';
     ...
     * @var string
     */
    protected $_cacheTag = 'mageplaza_promostandards_category';
     ...
     * @var string
     */
    protected $_eventPrefix = 'mageplaza_promostandards_category';

    /**
     * Post Collection
     *
     * @var \Mageplaza\PromoStandards\Model\ResourceModel\Post\Collection
     */
    ...
    {
        $this->_init('Mageplaza\PromoStandards\Model\ResourceModel\Category');
    }
    ...
    /**
     * move PromoStandards Category in tree
     *
     * @param $parentId
    ...
    public function move($parentId, $afterCategoryId)
    {
        try {
            ...
            throw new LocalizedException(
                __('Sorry, but we can\'t move the PromoStandards Category because we can\'t find the new parent PromoStandards Category you selected.'),
                $e
            );
        }
        ...
        if (!$this->getId()) {
            ...
            throw new LocalizedException(
                __('We can\'t perform this PromoStandards Category move operation because the parent PromoStandards Category matches the child PromoStandards Category.')
            );
        }
    ...
    public function getSelectedPostsCollection()
    {
        if (!$this->postCollection) {
            ...
            $collection->join(
                ['cat' => $this->getResource()->getTable('mageplaza_promostandards_post_category')],
