...
class AheadWorksM1 extends AbstractImport
{
     ...
     * @var string
     */
    const TABLE_POST = 'aw_promostandards';
    /**
     * AheadworksM1 Tag table name
     *
     * @var string
     */
    const TABLE_TAG = 'aw_promostandards_tags';
    /**
     * AheadworksM1 Category table name
     *
     * @var string
     */
    const TABLE_CATEGORY = 'aw_promostandards_cat';
    /**
     * AheadworksM1 Comment table name
     *
     * @var string
     */
    const TABLE_COMMENT = 'aw_promostandards_comment';
    /**
     * AheadworksM1 Category-Post Relationship table name
     *
     * @var string
     */
    const TABLE_CATEGORY_POST = 'aw_promostandards_post_cat';
                ...
                foreach ($tagIds as $id) {
                    try {
                        ...
                        $this->_resourceConnection->getConnection()
                            ->insert(
                                $this->_resourceConnection->getTableName('mageplaza_promostandards_post_tag'),
    ...
    protected function _importCategories($data, $connection)
    {
        ...
        if ($isReplace && isset($sourceItems)) {
            ...
            $this->_importCategoryPost($data, $connection, $oldCategoryIds, 'mageplaza_promostandards_post_category');
        }
